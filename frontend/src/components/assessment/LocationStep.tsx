...
type Props = Pick<AssessmentState, "stepAnimClass" | "radius" | "setRadius" | "userCoords" | "setUserCoords" | "locationText" | "setLocationText" | "geoResolved" | "geoStatus" | "searchLocationQuery" | "setSearchLocationQuery" | "isSearchingLocation" | "manualOverrideOpen" | "setManualOverrideOpen" | "nearbyProfiles" | "handleLocationSearch" | "handleLocate" | "goToStep">;

export default function LocationStep({ stepAnimClass, radius, setRadius, userCoords, setUserCoords, locationText, setLocationText, geoResolved, geoStatus, searchLocationQuery, setSearchLocationQuery, isSearchingLocation, manualOverrideOpen, setManualOverrideOpen, nearbyProfiles, handleLocationSearch, handleLocate, goToStep }: Props) {
