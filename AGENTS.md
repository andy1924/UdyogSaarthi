...
The app shell is present and phone+OTP remains deferred. The apply-section
voice assistant (on-device Whisper +
...
3. `docs/frontend/DESIGN.md` — visual truth. Rejects the retired Sarkaar
   Ledger visual language and any vermilion/stamp/perforation reference — stop
   and confirm if a task points there.
