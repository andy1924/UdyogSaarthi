  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface">
      ...
      <header className="sticky top-0 z-50 border-b border-outline-variant/60 bg-surface-container-lowest/95 backdrop-blur-md">
        <div className="flex min-h-16 w-full items-center justify-between gap-2 px-4 py-2 sm:px-6 lg:px-10">
          <button
            type="button"
            onClick={() => go('overview')}
      ...
      <div className="flex w-full items-stretch gap-0">
        <nav aria-label="Primary" className="sticky top-16 hidden h-[calc(100vh-4rem)] w-60 shrink-0 flex-col gap-1 overflow-y-auto px-4 py-6 md:flex">
      ...
      <nav aria-label="Primary" className="fixed inset-x-0 bottom-0 z-50 border-t border-outline-variant/60 bg-surface-container-lowest/98 pb-[env(safe-area-inset-bottom)] backdrop-blur-md md:hidden">
