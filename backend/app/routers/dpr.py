...
def render(inp: DPRGenerateIn):
    ...
    data = {
        ...
        "sections": ["Cover", "Feasibility", "Scheme Structure", "CAPEX/OPEX", "EQI Schedule", "License Checklist", "Declaration"],
    }
    # In full impl this would enqueue Celery + write S3 via WeasyPrint; here sync mock
    return DPRGenerateOut(dpr_id=dpr_id, pdf_url=f"/mock/{dpr_id}.pdf", status="ready", data=data, verified=inp.verified)
